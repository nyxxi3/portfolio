...
import './about.css'
import CV from '../../assets/jeevitha-cv.pdf'
            ...
            <div className="about__centered-container">
                <div className="about__text-block">
                    <p className="about__description">
                        I build responsive web interfaces React. I’m actively building projects to sharpen my skills and bring ideas to life.
